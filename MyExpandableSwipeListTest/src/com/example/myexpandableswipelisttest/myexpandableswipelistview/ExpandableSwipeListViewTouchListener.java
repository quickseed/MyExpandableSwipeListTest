...
package com.example.myexpandableswipelisttest.myexpandableswipelistview;
...
public class ExpandableSwipeListViewTouchListener implements View.OnTouchListener {
    ...
    private int swipeMode = MyExpandableSwipeListView.SWIPE_MODE_BOTH;
    ...
    private int swipeGroupView = 0;//jin
    ...
    // Fixed properties
    private MyExpandableSwipeListView swipeListView;
    ...
    private int swipeCurrentAction = MyExpandableSwipeListView.SWIPE_ACTION_NONE;

    private int swipeActionLeft = MyExpandableSwipeListView.SWIPE_ACTION_REVEAL;
    private int swipeActionRight = MyExpandableSwipeListView.SWIPE_ACTION_REVEAL;
     ...
     */
    public ExpandableSwipeListViewTouchListener(MyExpandableSwipeListView swipeListView, int swipeFrontView, int swipeBackView,int swipeGroupView) {
        this.swipeFrontView = swipeFrontView;
        this.swipeBackView = swipeBackView;
        this.swipeGroupView = swipeGroupView;//jin
    ...
    protected boolean isSwipeEnabled() {
        return swipeMode != MyExpandableSwipeListView.SWIPE_MODE_NONE;
    }
...
//        }//
    ...
    private void swapChoiceState(int position) {
        ...
        if (lastCount == 0 && count == 1) {
            ...
            closeOpenedItems();
            setActionsTo(MyExpandableSwipeListView.SWIPE_ACTION_CHOICE);
        }
    ...
    private void generateAnimate(final View view, final boolean swap, final boolean swapRight, final int position) {
        ...
        if (swipeCurrentAction == MyExpandableSwipeListView.SWIPE_ACTION_REVEAL) {
            generateRevealAnimate(view, swap, swapRight, position);
        }
        if (swipeCurrentAction == MyExpandableSwipeListView.SWIPE_ACTION_DISMISS) {
            generateDismissAnimate(parentView, swap, swapRight, position);
        }
        if (swipeCurrentAction == MyExpandableSwipeListView.SWIPE_ACTION_CHOICE) {
    ...
    private void resetCell() {
        if (downPosition != ExpandableListView.INVALID_POSITION) {
            if (swipeCurrentAction == MyExpandableSwipeListView.SWIPE_ACTION_CHOICE) {
            ...
            frontView = null;
            backView = null;
            downPosition = ExpandableListView.INVALID_POSITION;
        }
    }
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        ...
        switch (MotionEventCompat.getActionMasked(motionEvent)) {
            case MotionEvent.ACTION_DOWN: {
                if (paused && downPosition != ExpandableListView.INVALID_POSITION) {
                    return false;
                }
                swipeCurrentAction = MyExpandableSwipeListView.SWIPE_ACTION_NONE;
            ...
            case MotionEvent.ACTION_UP: {
                if (velocityTracker == null || !swiping || downPosition == ExpandableListView.INVALID_POSITION) {
                    break;
                }
                ...
                if (!opened.get(downPosition)) {
                    if (swipeMode == MyExpandableSwipeListView.SWIPE_MODE_LEFT && velocityTracker.getXVelocity() > 0) {
                        velocityX = 0;
                    }
                    if (swipeMode == MyExpandableSwipeListView.SWIPE_MODE_RIGHT && velocityTracker.getXVelocity() < 0) {
                        velocityX = 0;
                    }
                }
...
//                }
            ...
            case MotionEvent.ACTION_MOVE: {
                if (velocityTracker == null || paused || downPosition == ExpandableListView.INVALID_POSITION) {
                    break;
                }
                ...
                if (swipeMode == MyExpandableSwipeListView.SWIPE_MODE_NONE) {
                    deltaMode = 0;
                } else if (swipeMode != MyExpandableSwipeListView.SWIPE_MODE_BOTH) {
                    if (opened.get(downPosition)) {
                        if (swipeMode == MyExpandableSwipeListView.SWIPE_MODE_LEFT && deltaX < 0) {
                            deltaMode = 0;
                        } else if (swipeMode == MyExpandableSwipeListView.SWIPE_MODE_RIGHT && deltaX > 0) {
                            deltaMode = 0;
                        }
                    } else {
                        if (swipeMode == MyExpandableSwipeListView.SWIPE_MODE_LEFT && deltaX > 0) {
                ...
                if (deltaMode > slop && swipeCurrentAction == MyExpandableSwipeListView.SWIPE_ACTION_NONE && velocityY < velocityX) {
                    swiping = true;
                    ...
                    if (opened.get(downPosition)) {
                        ...
                        swipeCurrentAction = MyExpandableSwipeListView.SWIPE_ACTION_REVEAL;
                    } else {
                        if (swipingRight && swipeActionRight == MyExpandableSwipeListView.SWIPE_ACTION_DISMISS) {
                            swipeCurrentAction = MyExpandableSwipeListView.SWIPE_ACTION_DISMISS;
                        } else if (!swipingRight && swipeActionLeft == MyExpandableSwipeListView.SWIPE_ACTION_DISMISS) {
                            swipeCurrentAction = MyExpandableSwipeListView.SWIPE_ACTION_DISMISS;
                        } else if (swipingRight && swipeActionRight == MyExpandableSwipeListView.SWIPE_ACTION_CHOICE) {
                            swipeCurrentAction = MyExpandableSwipeListView.SWIPE_ACTION_CHOICE;
                        } else if (!swipingRight && swipeActionLeft == MyExpandableSwipeListView.SWIPE_ACTION_CHOICE) {
                            swipeCurrentAction = MyExpandableSwipeListView.SWIPE_ACTION_CHOICE;
                        } else {
                            swipeCurrentAction = MyExpandableSwipeListView.SWIPE_ACTION_REVEAL;
                        }
                ...
                if (swiping && downPosition != ExpandableListView.INVALID_POSITION) {
                    if (opened.get(downPosition)) {
    ...
    public void move(float deltaX) {
        ...
        } else if (swipeCurrentAction == MyExpandableSwipeListView.SWIPE_ACTION_CHOICE) {
